...
final class DataTableType implements DataTableTypeInterface
{
    ...
    public function buildDataTable(DataTableBuilderInterface $builder, array $options): void
    {
        $setters = [
            ...
            'turbo_frame_identifier' => $builder->setTurboFrameIdentifier(...),
        ];
    ...
    public function buildView(DataTableView $view, DataTableInterface $dataTable, array $options): void
    {
        ...
        $view->vars = array_replace($view->vars, [
            ...
            'turbo_frame_identifier' => $dataTable->getConfig()->getTurboFrameIdentifier(),
        ]);
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver
            ->setDefaults([
                ...
                'turbo_frame_identifier' => $this->defaults['turbo_frame_identifier'] ?? null,
            ])
