 ...
 */
class Kreyu_Bundle_DataTableBundle_Tests_Fixtures_KernelTestDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->aliases = [
            'Kreyu\\Bundle\\DataTableBundle\\Tests\\Fixtures\\Kernel' => 'kernel',
        ];
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Kreyu_Bundle_DataTableBundle_Tests_Fixtures_KernelTestDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'KreyuDataTableBundle' => 'Kreyu\\Bundle\\DataTableBundle\\KreyuDataTableBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'KreyuDataTableBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/src'),
                    'namespace' => 'Kreyu\\Bundle\\DataTableBundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'Kreyu_Bundle_DataTableBundle_Tests_Fixtures_KernelTestDebugContainer',
